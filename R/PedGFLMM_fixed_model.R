...
#' fixed_fsp
PedGFLMM_fixed_model = function(ped, geno, covariate, pos, order, beta_basis, geno_basis,
                                base = "bspline", distribution = 'binomial', Wald = FALSE)
  {
    ...
    ###
    fit     = pedigreemm( trait ~ covariate + UJ + (1|ID) , pedigree = list(ID = ped_list), data=ped, family = distribution)
